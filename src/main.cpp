...
const string strMessageMagic = "Hyper8 Signed Message:\n";
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
    ...
    {
    nRewardCoinYear = 0 * MAX_MINT_PROOF_OF_STAKE; // 0%
    }
    
    else if (pindexBest->nHeight+1 <= 20160)
    {
    nRewardCoinYear = MAX_MINT_PROOF_OF_STAKE; // 8%
    }
    
    else if (pindexBest->nHeight+1 <= 30240)
    {
    nRewardCoinYear = 111 * MAX_MINT_PROOF_OF_STAKE; // 888%
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Hyper8", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Tue, 14 Apr 2015 15:32:27 GMT";
        CTransaction txNew;
        txNew.nTime = 1429025547;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1429025547;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1625400;
		if(fTestNet)
        {
            block.nNonce   = 1625400;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x8dbad8cd0fd1566d07bc5f27deebe589473b9fd09246859e0a43a131d87ec671"));
        block.print();
